    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-show="activeData.type!=='absolute'" label="尺寸">
            <el-radio-group v-model="activeData.__config__.elementSize">
              <el-radio-button label="固定" />
              <el-radio-button label="比例" />
            </el-radio-group>
          </el-form-item>
          <el-form-item v-if="activeData.__config__.elementSize==='固定' && activeData.type!='absolute'" label="width">
            <el-input v-model.number="activeData.__config__.rowWidth" type="number" placeholder="请输入width" />
          </el-form-item>
          <el-form-item v-if="activeData.__config__.elementSize==='固定' && activeData.type!='absolute'" label="height">
            <el-input v-model.number="activeData.__config__.rowHeight" type="number" placeholder="请输入height" />
            height为0表示自适应
          </el-form-item>
          <el-form-item v-if="activeData.__config__.span!==undefined && activeData.__config__.elementSize==='比例' && activeData.type!='absolute'" label="表单栅格">
            <el-slider v-model="activeData.__config__.span" :max="100" :min="1" :marks="{50:''}" @change="spanChange" />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.type=='absolute'" label="width">
            <el-input v-model.number="activeData.__config__.rowWidth" type="number" placeholder="请输入width" />
          </el-form-item>
          <el-form-item v-if="activeData.type=='absolute'" label="height">
            <el-input v-model.number="activeData.__config__.rowHeight" type="number" placeholder="请输入height" />
          </el-form-item>
          <el-form-item v-if="activeData.type=='absolute'" label="left">
            <el-input v-model.number="activeData.__config__.rowLeft" type="number" placeholder="请输入left" />
          </el-form-item>
          <el-form-item v-if="activeData.type=='absolute'" label="top">
            <el-input v-model.number="activeData.__config__.rowTop" type="number" placeholder="请输入top" />
          </el-form-item>
